...
public static partial class Plugin
{
     ...
     static void CreatePermafrost()
    {
        ...
        var weap = new WeaponRecord
        {
            ...
            RangeThrowbackChanceBonus = 0,
            RampUpValue = 1,
            ObstaclePierceChanceBonus = 50,
            CreaturePierceBonus = 0.25f,
            WoundChanceOnPierce = 0,
